        ...
        <main className='bg-slate-100'>
            ...
            <section className='flex p-10 justify-between'>
                <div className='pr-5'>
                    ...
                    <button onClick={handleLike} class="py-1.5 px-3 hover:text-green-600 hover:scale-105 hover:shadow text-center border border-gray-300 rounded-md border-gray-400 h-8 text-sm flex items-center gap-1 lg:gap-2">

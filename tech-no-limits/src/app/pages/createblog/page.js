...
const Page = () => {
    ...
    const [data, setData] = useState({
        title: '',
        body: '',
        author: session?.user?.id || '', // Utilisez ? pour éviter les erreurs si session ou user n'est pas défini
        category: '',
        images: []
    });
    useEffect(() => {
    ...
    const handleImageChange = (e) => {
        ...
        setData({ ...data, images: files }); // Mettre à jour les images dans le state
    };

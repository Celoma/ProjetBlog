...
const page = ({ params }) => {
    ...
    return (
        <main>
            ...
            <h2 className='pl-[140px] mt-10 text-2xl font-semibold'><em className='bg-custom-blue text-slate-100 not-italic'> Lire</em> les blogs de l'auteur</h2>
            <div className="grid grid-cols-3 gap-4 px-[140PX] m-10">

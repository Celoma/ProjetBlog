  ...
  return (
    <div className="bg-custom-purple flex items-center justify-between h-15 sticky">  
      ...
      <div> {/* boutons vers pages de log-in sign-in*/}
        <a href="" className="text-slate-100 mr-2 font-semibold hover:text-gray-400">Login</a>

      <button className="btn relative inline-flex items-center justify-start overflow-hidden transition-all bg-custom-orange rounded hover:bg-custom-orange group mr-5 ml-2 p-2">
        {/* purple box */}

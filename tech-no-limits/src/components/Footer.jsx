            ...
            <div className="flex place-content-between">
                ...
                <div className="mt-28 mr-40">
                    ...
                    <form class="max-w-lg mx-auto flex">
                        <input type="email" id="email" class="bg-custom-gray border border-gray-300 text-gray-900 text-sm rounded-l-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Rentre ton email" required />
